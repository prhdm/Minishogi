...
public class GoldGeneral extends Pieces {
    ...
    public GoldGeneral(Side side) {
        this.side=side;
        name = side == Side.BLACK ? 'g' : 'G';
        pieceImage = side == Side.BLACK ? resourceManager.sithGoldGeneral : resourceManager.jediGoldGeneral;
    }
    ...
    public Pieces changeSide() {
        return new GoldGeneral(this.side==Side.BLACK?Side.WHITE:Side.BLACK);
    }
